...
export function generateGroupMatches() {
  return [
    ...
    { id:27, group:"E", home:"Germany",             away:"Ivory Coast",           date:"Sat 20 Jun", time:"02:00", venue:"SoFi Stadium, Los Angeles", result:null },
    { id:28, group:"E", home:"Ecuador",             away:"Curaçao",               date:"Sat 20 Jun", time:"05:00", venue:"Hard Rock Stadium, Miami", result:null },
    { id:29, group:"E", home:"Ecuador",             away:"Germany",               date:"Fri 26 Jun", time:"02:00", venue:"MetLife Stadium, New Jersey", result:null },
    { id:30, group:"E", home:"Curaçao",             away:"Ivory Coast",           date:"Fri 26 Jun", time:"02:00", venue:"Lincoln Financial Field, Philadelphia", result:null },
    // GROUP F
    ...
    { id:35, group:"F", home:"Japan",               away:"Tunisia",               date:"Fri 26 Jun", time:"05:00", venue:"BC Place, Vancouver", result:null },
    { id:36, group:"F", home:"Sweden",              away:"Netherlands",           date:"Fri 26 Jun", time:"05:00", venue:"Lumen Field, Seattle", result:null },
    // GROUP G
    { id:37, group:"G", home:"Belgium",             away:"Egypt",                 date:"Mon 15 Jun", time:"23:00", venue:"AT&T Stadium, Dallas", result:null },
    { id:38, group:"G", home:"Iran",                away:"New Zealand",           date:"Tue 16 Jun", time:"02:00", venue:"SoFi Stadium, Los Angeles", result:null },
    { id:39, group:"G", home:"Egypt",               away:"New Zealand",           date:"Sun 21 Jun", time:"23:00", venue:"Gillette Stadium, Boston", result:null },
    { id:40, group:"G", home:"Belgium",             away:"Iran",                  date:"Mon 22 Jun", time:"02:00", venue:"Houston Stadium, Houston", result:null },
    { id:41, group:"G", home:"Iran",                away:"Egypt",                 date:"Sat 27 Jun", time:"02:00", venue:"Hard Rock Stadium, Miami", result:null },
    { id:42, group:"G", home:"New Zealand",         away:"Belgium",               date:"Sat 27 Jun", time:"02:00", venue:"Mercedes-Benz Stadium, Atlanta", result:null },
    // GROUP H
    ...
    // GROUP I
    { id:49, group:"I", home:"France",              away:"Senegal",               date:"Tue 16 Jun", time:"23:00", venue:"Levi's Stadium, San Francisco", result:null },
    ...
    { id:53, group:"I", home:"Norway",              away:"France",                date:"Sun 28 Jun", time:"02:00", venue:"BC Place, Vancouver", result:null },
    { id:54, group:"I", home:"Senegal",             away:"Iraq",                  date:"Sun 28 Jun", time:"02:00", venue:"Levi's Stadium, San Francisco", result:null },
    // GROUP J
    { id:55, group:"J", home:"Argentina",           away:"Algeria",               date:"Tue 16 Jun", time:"02:00", venue:"Mercedes-Benz Stadium, Atlanta", result:null },
    { id:56, group:"J", home:"Austria",             away:"Jordan",                date:"Wed 17 Jun", time:"05:00", venue:"Lincoln Financial Field, Philadelphia", result:null },
    ...
    { id:59, group:"J", home:"Jordan",              away:"Argentina",             date:"Sun 28 Jun", time:"05:00", venue:"Mercedes-Benz Stadium, Atlanta", result:null },
    { id:60, group:"J", home:"Algeria",             away:"Austria",               date:"Sun 28 Jun", time:"05:00", venue:"Houston Stadium, Houston", result:null },
    // GROUP K
    { id:61, group:"K", home:"Portugal",            away:"DR Congo",              date:"Wed 17 Jun", time:"23:00", venue:"SoFi Stadium, Los Angeles", result:null },
    { id:62, group:"K", home:"Uzbekistan",          away:"Colombia",              date:"Thu 18 Jun", time:"02:00", venue:"AT&T Stadium, Dallas", result:null },
    ...
    { id:65, group:"K", home:"Colombia",            away:"Portugal",              date:"Mon 29 Jun", time:"02:00", venue:"SoFi Stadium, Los Angeles", result:null },
    { id:66, group:"K", home:"DR Congo",            away:"Uzbekistan",            date:"Mon 29 Jun", time:"02:00", venue:"AT&T Stadium, Dallas", result:null },
    // GROUP L
    { id:67, group:"L", home:"England",             away:"Croatia",               date:"Thu 18 Jun", time:"05:00", venue:"MetLife Stadium, New Jersey", result:null },
    { id:68, group:"L", home:"Ghana",               away:"Panama",                date:"Thu 18 Jun", time:"09:00", venue:"Gillette Stadium, Boston", result:null },
    { id:69, group:"L", home:"Croatia",             away:"Panama",                date:"Wed 24 Jun", time:"05:00", venue:"Hard Rock Stadium, Miami", result:null },
    { id:70, group:"L", home:"England",             away:"Ghana",                 date:"Thu 25 Jun", time:"02:00", venue:"Lincoln Financial Field, Philadelphia", result:null },
    { id:71, group:"L", home:"Panama",              away:"England",               date:"Mon 29 Jun", time:"05:00", venue:"Houston Stadium, Houston", result:null },
    { id:72, group:"L", home:"Croatia",             away:"Ghana",                 date:"Mon 29 Jun", time:"05:00", venue:"Gillette Stadium, Boston", result:null },
  ];
}
